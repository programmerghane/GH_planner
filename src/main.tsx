...
> {
  ...
  componentDidCatch(error: any, info: any) {
    console.error('GH Planner Error:', error, info);
  }
  render() {
    if (this.state.hasError) {
      return (
        <div style={{
          ...
          <h2 style={{color:'#f87171',marginBottom:'0.5rem'}}>خطایی رخ داد</h2>
          <p style={{color:'#94a3b8',marginBottom:'1.5rem',textAlign:'center',fontSize:'0.875rem'}}>
            {this.state.error}
          </p>
          <button
